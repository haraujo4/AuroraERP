...
export function ProfitCenterForm() {
        ...
        <div className="flex flex-col h-full bg-bg-main p-4">
            <div className="flex items-center justify-between mb-4 bg-white p-2 rounded border border-border-default shadow-sm">
                <div className="flex items-center space-x-2">
                    <button onClick={() => navigate('/admin/profit-centers')} className="p-2 text-text-secondary hover:text-brand-primary" title="Voltar">
                        <ArrowLeft size={20} />
                    </button>
                    <h1 className="text-xl font-bold text-text-primary">
                        {isEdit ? 'Editar Centro de Lucro' : 'Novo Centro de Lucro'}
                    </h1>
                </div>
                <div className="flex items-center space-x-2">
                    <button
                ...
                <form onSubmit={handleSubmit} className="max-w-2xl grid grid-cols-2 gap-6">
                    ...
                    <div className="space-y-1">
                        ...
                        <input
                            type="text"
                            name="codigo"
                            value={formData.codigo || 'CLxxxx (Auto)'}
                            disabled
