...
export function ProfitCenterList() {
    ...
    const columns: Column<CentroLucro>[] = [
        ...
        <div className="flex flex-col h-full bg-bg-main p-4">
            <div className="flex items-center justify-between mb-4 bg-white p-2 rounded border border-border-default shadow-sm z-20">
                <div className="flex items-center space-x-4">
                    <h1 className="text-xl font-bold text-text-primary">Gestão de Centros de Lucro</h1>
                    <div className="flex items-center gap-2">
                        <span className="text-[10px] font-bold bg-bg-secondary text-text-secondary px-1.5 py-0.5 rounded border border-border-default">KE51</span>
                    </div>
            ...
            <div className="flex-1 overflow-hidden">
                <ALVGrid
                    ...
                    onRowClick={(pc) => navigate(`/admin/profit-centers/${pc.id}`)}
                />
            </div>
        </div>
    );
